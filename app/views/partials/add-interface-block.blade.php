...
<div class="appInterfaceInputs">
	<div class="form-group required">
		...
		<input type="text" class="form-control" name="applicationName" required value="@if( isset( $interfaceObject) ){{$interfaceObject->applicationName}}@endif"/>
	</div>
	<div class="form-group">
		<label class="control-label">Application Description</label>
		<input type="text" class="form-control" name="applicationDescription" value="@if( isset( $interfaceObject) ){{ $interfaceObject->applicationDescription}}@endif" />
	</div>
	<div class="form-group">
		...
		<input type="button" class="btn btn-default add-app-module" value="Add Application Module"/>
	</div>
	<div class="form-group">
		@if( isset( $interfaceObject))
